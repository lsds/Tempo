...
class ModelBuilder:
    def __init__(
        ...
        self._encoder: Module | None = None
        self._encoder_latent_size: int | None = None

        self._hidden: Module | None = None
        self._last_hidden_size: int | None = None

        self._decoder1: Module | None = None
        self._decoder2: Module | None = None
    ...
    def with_ff_encoder(
        ...
        bias: bool = True,
        activation_fun: ActivationFunctionLike | None = None,
...
class NormalDistDecoder(Module):
    def __init__(
        ...
        independent_domain: DomainLike = None,
        squish: bool = False,
        w_init_fun: Callable[[Shape, DataType], RecurrentTensor] | None = None,
    ) -> None:
...
class QNetwork(Network):
    def __init__(self, builder: ModelBuilder) -> None:
        ...
        self._decoder2: Module | None = builder._decoder2
...
class VNetwork(Network):
    ...
    ) -> tuple[ActionsRecurrentTensor | None, ValueRecurrentTensor]:
        x = self._encoder(obs)
        x = self._hidden(x)
...
class NormalDistPiNetwork(Network):
    def __init__(self, builder: ModelBuilder) -> None:
        ...
        self._actions_base: RecurrentTensor | None = None
...
# NOTE: Alternative name for ModelBuilder
DNNBuilder = ModelBuilder
